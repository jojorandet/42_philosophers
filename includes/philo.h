...
/*   Updated: 2025/06/12 17:17:42 by jrandet          ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
# define STR_NOT_NUM " %s: Input must be a number, ex: 5 800 200 200, no \
letters."
# define STR_INT_TOO_BIG "%s: Input %s is above int_max, please give valid \
input."
# define STR_TOO_MANY_THREADS "%s: Exceeded the maximum amount of philosophers \
for optimal performance, please give <number_of_philosophes> <= 200"
...
/**
 * @param Parameters are the parameters given to launch the phoilosopher
 *  simulation
 ...
 * @param write_lock Pointer to shared mutex used for controlled output 
 * synchronization.
